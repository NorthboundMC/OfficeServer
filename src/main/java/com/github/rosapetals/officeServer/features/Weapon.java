...
public enum Weapon {
    ...
    LINT_TRAY(CC.translate("&lLint Tray"),
            new WeaponData(CC.translate("&lLint Tray"),
                    ItemUtils.CreateCustomItem(new ItemStack(Material.MACE), CC.translate("&lLint Tray"), CC.translate("A heavy lint tray \\Hit people while you are falling for massive damage"), false),
                    1,
                    null,
                    null,
                    0.6,
    ...
    FORK(CC.translate("&lFork"),
            new WeaponData(CC.translate("&lFork"),
                    ...
                    1,
                    List.of(Enchantment.UNBREAKING, Enchantment.LOYALTY),
                    List.of(2, 3),
                    1.1,
                    9,
                    false,
    ...
    BAKING_POWDER(CC.translate("&lBaking Powder"),
            new WeaponData(CC.translate("&lBaking Powder"),
                    ItemUtils.CreateCustomItem(new ItemStack(Material.WIND_CHARGE), CC.translate("&lBaking Powder"), CC.translate("Some baking powder\\Throw it to create a powerful splash that causes knockback"), false),
                    1,
                    null,
                    null,
                    20,
